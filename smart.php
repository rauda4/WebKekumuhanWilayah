...
for($i=0;$i<=$jump;$i++){
	...
	$arM1[$i]=bul(($nMax1-$arN1[$i]) /($nMax1-$nMin1));
	$arM2[$i]=bul(($nMax2-$arN2[$i]) /($nMax2-$nMin2));
	$arM3[$i]=bul(($nMax3-$arN3[$i]) /($nMax3-$nMin3));
	$arM4[$i]=bul(($nMax4-$arN4[$i]) /($nMax4-$nMin4));
	$arM5[$i]=bul(($nMax5-$arN5[$i]) /($nMax5-$nMin5));
	$arM6[$i]=bul(($nMax6-$arN6[$i]) /($nMax6-$nMin6));
	$arM7[$i]=bul(($nMax7-$arN7[$i]) /($nMax7-$nMin7));
	$arM8[$i]=bul(($nMax8-$arN8[$i]) /($nMax8-$nMin8));
	$arM9[$i]=bul(($nMax9-$arN9[$i]) /($nMax9-$nMin9));
	$arM10[$i]=bul(($nMax10-$arN10[$i]) /($nMax10-$nMin10));
	$arM11[$i]=bul(($nMax11-$arN11[$i]) /($nMax11-$nMin11));
	$arM12[$i]=bul(($nMax12-$arN12[$i]) /($nMax12-$nMin12));
	$arM13[$i]=bul(($nMax13-$arN13[$i]) /($nMax13-$nMin13));
	$arM14[$i]=bul(($nMax14-$arN14[$i]) /($nMax14-$nMin14));
	$arM15[$i]=bul(($nMax15-$arN15[$i]) /($nMax15-$nMin15));
	$arM16[$i]=bul(($nMax16-$arN16[$i]) /($nMax16-$nMin16));
	$arM17[$i]=bul(($nMax17-$arN17[$i]) /($nMax17-$nMin17));
	$arM18[$i]=bul(($nMax18-$arN18[$i]) /($nMax18-$nMin18));
	$arM19[$i]=bul(($nMax19-$arN19[$i]) /($nMax19-$nMin19));

	
	
	
	$arM1S[$i]="($nMax1-$arN1[$i]) /($nMax1-$nMin1)";
	$arM2S[$i]="($nMax2-$arN2[$i]) /($nMax2-$nMin2)";
	$arM3S[$i]="($nMax3-$arN3[$i]) /($nMax3-$nMin3)";
	$arM4S[$i]="($nMax4-$arN4[$i]) /($nMax4-$nMin4)";
	$arM5S[$i]="($nMax5-$arN5[$i]) /($nMax5-$nMin5)"; 
	$arM6S[$i]="($nMax6-$arN6[$i]) /($nMax6-$nMin6)";
	$arM7S[$i]="($nMax7-$arN7[$i]) /($nMax7-$nMin7)";
	$arM8S[$i]="($nMax8-$arN8[$i]) /($nMax8-$nMin8)";
	$arM9S[$i]="($nMax9-$arN9[$i]) /($nMax9-$nMin9)";
	$arM10S[$i]="($nMax10-$arN10[$i]) /($nMax10-$nMin10)"; 
	$arM11S[$i]="($nMax11-$arN11[$i]) /($nMax11-$nMin11)";
	$arM12S[$i]="($nMax12-$arN12[$i]) /($nMax12-$nMin12)";
	$arM13S[$i]="($nMax13-$arN13[$i]) /($nMax13-$nMin13)";
	$arM14S[$i]="($nMax14-$arN14[$i]) /($nMax14-$nMin14)";
	$arM15S[$i]="($nMax15-$arN15[$i]) /($nMax15-$nMin15)"; 
	$arM16S[$i]="($nMax16-$arN16[$i]) /($nMax16-$nMin16)";
	$arM17S[$i]="($nMax17-$arN17[$i]) /($nMax17-$nMin17)";
	$arM18S[$i]="($nMax18-$arN18[$i]) /($nMax18-$nMin18)";
	$arM19S[$i]="($nMax19-$arN19[$i]) /($nMax19-$nMin19)";
	//=========================================
	...
	$VF[$i]=$arB1[$i]+$arB2[$i]+$arB3[$i]+$arB4[$i]+$arB5[$i]+$arB6[$i]+$arB7[$i]+$arB8[$i]+$arB9[$i]+$arB10[$i]+$arB11[$i]+$arB12[$i]+$arB13[$i]+$arB14[$i]+$arB15[$i]+$arB16[$i]+$arB17[$i]+$arB18[$i]+$arB19[$i];
	$VF[$i]=bul($VF[$i],2);
	$arRekap[$i]=$SF[$i]."=".$VF[$i]; 
}
...
$gdata.="</table>";
$gambar="<img src='ypathfile/' width='300' height='200'><br>Pembentukan Matrik Normalisasi";
$gab="<h4>Menentukan Nilai Min dan Max</h4><div> $gdata <br></div>";
echo $gab;
//================================================
$gdata="<table id='table'><tr bgcolor='#cccccc'><th>No<th>Kelurahan";
$gdata.= "<th><label title='$m1 :$kr11 $bobot1 %'><small>$lb11</label></th>";
...
$gdata.="</table><br><h4>Rumus Menentukan Nilai Utility</h4></br>";
$gambar="<img src='ypathfile/smart3.png' width='500' height='200'>";
$gab="<h4>Menentukan Nilai Utility </h4><div> $gdata <br>$gambar</div>";
echo $gab;
...
$gdata.="</table> <br><h4>Rumus Menentukan Nilai Akhir</h4></br>";
$gambar="<img src='ypathfile/smart4.png' width='300' height='150'><br></br>";
$gab="<h4>Nilai utility Data penilaian</h4><div> $gdata $gambar
...
$gab="<h4> Menghitung Nilai <b>Bobot<sub>SMART</sub></b></h4><div> $gdata 
...
$sql2="update `tb_hasil`  set `rekapitulasi_2`='$rekapitulasi',`bobot_2`='$VF[$i]', 
`rangking_2`='$no' where `id_kelurahan`='$id_kelurahan' and `id_penilaian`='$id_penilaian'";
$up=process($conn,$sql2);
