...
$NOM=0;
$sqlc = "select * from `$tbpenilaian` order by `id_penilaian` desc";
...
<!-- display data rekap by id_penilaian -->
<table class="table table-bordered">
	<tr bgcolor="#cccccc">
		<th width="3%">No</td> 
		<th width="80%">Hasil Analisa Penilaian</td>
		<th width="5%">SAW</td>
		<th width="5%">SMART</td>
		<th width="13%">Menu</td>
	</tr>
	...
	$sqld = "select `nama_kelurahan`,`deskripsi` from `$tbkelurahan` where `id_kelurahan`='$id_kelurahan'";
		...
		$gab1.="['$nama_kelurahan',$bobot_1],";
		$gab2.="['$nama_kelurahan',$bobot_2],";
...
echo "<tr bgcolor='$color'>
	...
	<br>
	<small><b>SA:</b><i>$rekapitulasi_1</i></small>
...
<td width="50%">
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('piechart<?php echo $NOM;?>'));
        chart.draw(data, options);
      }
    </script> 
    <div id="piechart<?php echo $NOM;?>" style="width: 300px; height: 500px;"></div>
...
<td width="50%">
  <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var chart = new google.visualization.PieChart(document.getElementById('piechart2<?php echo $NOM;?>'));
        chart.draw(data, options);
      }
    </script> 
    <div id="piechart2<?php echo $NOM;?>" style="width: 300px; height: 500px;"></div>
...
foreach ($arrc as $dc) {
		...
		$gab1.="$nama_penilaian,";
		$gab2.="$nama_penilaian,";
	 $sql = "select * from `$tbhasil` where  `id_penilaian`='$id_penilaian' order by `id_kelurahan` asc";
	 $arr = getData($conn, $sql);
	 $head="['#', ";
	 $no=0;
		foreach ($arr as $d) {
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            title: 'Tingkat Kekumuhan Kawasan Berdasarkan Kecamatan',
            subtitle: 'Pasar Minggu SAW, Jagakarsa SAW, Cilandak SAW, Pasar Minggu SMART, Jagakarsa SMART, and Cilandak SMART: Mei 2022 - Juli 2022',
          }
        };
